<ul class="nav navbar-nav pull-right">
            ...
            <li>
                <ul class="dropdown-menu-list scroller" style="height: 275px;"
                    ...
                    <li>
                        <a href="#">
                                                        <span class="photo">
                                                            <img src="<?php echo cdn_assets(); ?>layouts/layout3/img/avatar.png"
    ...
    <li class="dropdown dropdown-user dropdown-dark">
        <a href="javascript:;" class="dropdown-toggle" data-toggle="dropdown"
           data-hover="dropdown" data-close-others="true">
            <img alt="" class="img-circle"
                 src="<?php echo cdn_assets(); ?>layouts/layout3/img/avatar.png">
            <span class="username username-hide-mobile"> <?php echo get_attr_session('usr_nombre'); ?> </span>
        </a>
        <ul class="dropdown-menu dropdown-menu-default">
            ...
            <li>
                <a href="<?php echo base_url('admin_sys/salir'); ?>">
